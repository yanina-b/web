...
https://github.com/yanina-b/web/blob/25b57b0c4abf27be8ad50c37df2caa7438e27d6b/%D0%A1%D0%BD%D0%B8%D0%BC%D0%BE%D0%BA%20%D1%8D%D0%BA%D1%80%D0%B0%D0%BD%D0%B0%202023-10-14%20170024.png

## 👙 “Голый” HTML тоже имеет стили ##
Если вы откроете предыдущую практику или домашку в браузере и исследуете её при помощи панели разработчика, то увидите созданные браузером стили. 
Для корректной разработки сайта (верстки) и корректного его отображения в разных браузерах необходимо обнулить все базовые стили.
В этом вам поможет файл reset.css, которым я с вами поделюсь. (Есть на диске) https://drive.google.com/open?id=1sDk0HSroHhG53HhpnM2MUZpU3ODeef9y&usp=drive_copy
